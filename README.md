...
| [`domain-gloss`](skills/domain-gloss) | Keep the English domain term and attach an inline gloss in your first language — insurance, legal, and nonprofit jargon that teaches instead of blocking. |
