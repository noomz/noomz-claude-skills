...
| [`thai-natural-voice`](skills/thai-natural-voice) | Draft natural Thai for agent replies, technical work, and publishing — generic profiles, safe source-inspired presets, and `/capture-thai-voice` to capture a voice profile from a link, name, or document. |
